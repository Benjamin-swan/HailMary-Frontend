...
// 이미지 속 펜타곤의 중심·반지름. 배경 SVG 임베드 PNG를 픽셀 분석해 실측:
// 정오각형 중심 (227, 220), 5개 꼭짓점 네온 스트로크 중심선 반지름 ≈ 111.6 (편차 0.24).
// R은 점수 면적 stroke 두께(4px)의 절반을 빼 외곽선 안쪽에 들어오게 110으로 설정
// — 100점이 꼭짓점에 맞닿고, 그 미만 점수는 외곽선을 넘지 않는다.
const CX = 227;            // 펜타곤 중심 x
const CY = 220;            // 펜타곤 중심 y
const R = 110;             // 점수 100 → 꼭짓점(실측 111.6) 안쪽 마진
const SCORE_MIN = 30;
const SCORE_MAX = 100;
// ────────────────────────────────────────────────────────────
