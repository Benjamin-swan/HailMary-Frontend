...
const MOCK_P4: PaidChapterP4Doyoon = {
  ...
  info_rows: [
    ...
    { key: "감정 변동성", val: "기복이 큰 편" },
    { key: "행동 신호", val: "초기 과접근, 중반 급랭각" },
    { key: "갈등이 잦은 이유", val: "감정 주파수가 잘 안 맞음" },
    { key: "대응 전략", val: "초기 신호 2개 이상 시 즉시 거리 조정" },
  ],
  ai_akyon:
    "데이터로 추려본, 잘 안 맞는 유형이에요. 외형부터 보여드릴게요.\n\n" +
    "키 분포 — 평균보다 +5cm 이상인 경우가 64%. 체형은 마른 골격에 어깨가 좁은 편이 많아요. " +
    "얼굴은 광대가 도드라지고 턱선이 각진 편. 눈매는 끝이 올라가고 입술이 얇은 모습이 자주 함께 나타나요.\n\n" +
    "문제는 외형이 아니라 인상 점수예요. 첫인상 강도 91점 — 눈에 띄게 높아요. " +
    "근데 6개월 호감 유지율이 14점. 격차가 77점이에요. 평균 격차가 32점인 걸 감안하면 이 유형은 정말 조심하셔야 해요.\n\n" +
    "임수(壬水) 일간과는 감정의 결이 잘 안 맞는 편이에요. 초기에 끌려도 중반 이후엔 금세 식기 쉬워요. " +
    "첫 만남에서 위 신호가 두 개 이상 보이면 그냥 거리 두시는 게 나아요. 홍길동님 매력을 낭비하기엔 아까운 유형이에요.",
  ...
  ai_illusion:
    "임수(壬水) 일간은 착각 인연에 빠지는 경우가 유독 잦은 편이에요. " +
    "초기의 강한 끌림을 운명으로 오해하는 흐름이 자주 보이거든요.\n\n" +
    "핵심은 첫 만남 점수가 아니라 3개월차 호감 곡선의 기울기예요. " +
    "진짜 인연은 3개월 시점에 호감도가 +18% 올라가요. " +
    "착각 인연은 같은 시점에 -38% 떨어지고요. 이 기울기 차이가 첫 만남 점수보다 훨씬 잘 들어맞는 신호예요.\n\n" +
    "오인 신호 3종 — 첫 만남 점수 90+, 2주차 연락 빈도 급감, " +
    "3개월차 대화 온도 -38%. 두 가지 이상 보이면 한 번 더 확인하고 가세요.\n\n" +
    "홍길동님, 첫 만남 점수에 휘둘리지 마세요. 3개월 기다려 보는 게 가장 정확한 확인법이에요.",
  ...
  return (
    ...
    >
      <DoyoonPageHead
        ...
        hanja="二"
        title="연애를 막는 것 (2/2)"
        sub="구조적 원인 · 반복 패턴 · 조심해야 할 유형"
      />

      {/* ── 2-3 조심해야 할 유형 ── */}
      <DoyoonSection>
        <DoyoonSLabel>2-3 자주 부딪히는 유형</DoyoonSLabel>
        <DoyoonSTitle>데이터로 추려본, 잘 안 맞는 유형이에요.</DoyoonSTitle>
