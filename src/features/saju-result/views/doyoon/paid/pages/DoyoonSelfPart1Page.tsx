  ...
  return (
    ...
    >
      ...
      <DoyoonSection>
        ...
        <DoyoonSTitle>
          힘든 시기에는 감정이 평소의 {d.crisis_multiplier}까지 출렁입니다.
        </DoyoonSTitle>
        <DoyoonLineChartEmotion
          points={d.emotion_curve}
          caption={`힘든 시기 감정 출렁임 평소의 ${d.crisis_multiplier}`}
        />
