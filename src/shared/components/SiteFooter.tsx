...
export function SiteFooter() {
  return (
    <footer className="select-text bg-black/80 px-6 py-10 text-center text-[11px] leading-relaxed text-neutral-300">
      <Image
        src="/footer-logo.png"
        alt="도화선"
        width={72}
      ...
      <div className="mt-5 flex items-center justify-center gap-3">
        <a
          href="#"
          aria-label="카카오톡 채널"
          className="flex h-10 w-10 items-center justify-center rounded-full bg-neutral-700/80 text-neutral-200 transition-colors hover:bg-neutral-600"
        >
          <KakaoIcon />
        </a>
        <a
